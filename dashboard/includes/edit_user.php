...
if(isset($_POST['edit_user'])){
    ...
    ///make sure not to send empty image to database
    if(empty($user_image)){
 ...
 <section class="forms">
    ...
    <div class="card card_border py-2 mb-4">
                ...
                <div class="cards__heading">
                    <h3>User Edit Form <span></span></h3>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control input-style" id="inputPassword4"
                                    placeholder="Password" name="user_password" value="<?php echo $user_password;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-style" id="inputAddress"
                                placeholder="First Name" name="user_firstname" value="<?php echo $user_firstname;?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-style" id="inputAddress2"
                                placeholder="Last Name" name="user_lastname" value="<?php echo $user_lastname;?>">
                        </div>
                        <div class="form-row">
                           <!-- <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="form-control input-style" name="user_role">
                                    ...
                                    <?php
                                        if($user_role == "ASSITANT"){
                                            echo "<option value='ADMIN'>ADMIN</option>";
                                        }else{
                                            echo "<option value='ASSITANT'>ASSITANT</option>";
                                        }
                                    ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <img width="100" src="../dashboard/all_images/user_images/<?php echo $user_image;?>" alt="">
                       ...
                       <!-- <div class="form-check check-remember check-me-out">
                        ...
                        <button type="submit" class="btn btn-success btn-style mt-4" name="edit_user">Update User</button>
                    </form>
                </div>
